...
def get_column():
	return [
		...
		{"label": "Part Code", "fieldname": "part_name", "fieldtype": "Data", "width": 100},
		{
			"label": "Device Type",
...
def get_summary(data):
	...
	return [
		{"label": "Total Parts", "value": total_parts, "datatype": "Int"},
		{
			"label": "Below Reorder",
			"value": below_reorder,
			"datatype": "Int",
		...
		{"label": "Total Inventory Value", "value": total_inventory_value, "datatype": "Currency"},
	]
